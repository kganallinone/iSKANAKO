...
public class TestActivity extends AppCompatActivity {
	...
	private ArrayList<String> teststr = new ArrayList<>();
			...
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				...
				TEST.addListenerForSingleValueEvent(new ValueEventListener() {
					...
					public void onDataChange(DataSnapshot _dataSnapshot) {
						...
						teststr.add(_childKey);
						listview1.setAdapter(new Listview1Adapter(test));
	...
	public class Listview1Adapter extends BaseAdapter {
		...
		public View getView(final int _position, View _v, ViewGroup _container) {
			...
			no.setText(_data.get((int)_position).get("N").toString());
			date.setText(_data.get((int)_position).get("T").toString());
