...
public class DevMemberActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.dev_member);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		ActionBarDrawerToggle _toggle = new ActionBarDrawerToggle(DevMemberActivity.this, _drawer, _toolbar, R.string.app_name, R.string.app_name);
